...
<div class="videoControls upNext" style="display:none;">
    ...
    <div class="upNextContainer">
      ...
      <button onclick="watchVideo(<?php echo $upNextVideo->getId(); ?>)" class="playNext"><i class="fas fa-play"></i> Play</button>
    </div>
</div>
 ...
 <script type="text/javascript">
   initVideo("<?php echo $video->getId();?>","<?php echo $_SESSION["userLogged"]; ?>");
 </script>
